...
<xsl:template match="/">
    <html>
        <head>
            <title>AllMedia statistics</title>
        </head>
        <body>
            <xsl:apply-templates select="rtmp"/>
            <hr/>
            Generated by allmedia<xsl:value-of select="/rtmp/nginx_http_flv_version"/>,
            <a href="https://github.com/H-kernel/nginx-media-module">nginx-media-module</a>&#160;<xsl:value-of select="/http-flv/nginx_version"/>,
